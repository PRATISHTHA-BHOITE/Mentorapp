...
public class MentorPage extends AppCompatActivity implements View.OnClickListener {


    private FirebaseAuth firebaseAuth;
    private Button buttonout,Notif,profile;
    ...
    public void onClick(View v) {
        ...
        if(v == profile) {
            Toast.makeText(this,"My Profile",Toast.LENGTH_SHORT).show();
             Intent intent = new Intent(MentorPage.this, MentorProfile.class);
